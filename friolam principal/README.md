...
## Estructura
- `backend/`: panel admin, API REST, lógica de negocio, PDF y reportes.
- `mobile-pwa/`: app PWA para técnicos (celular/tablet).
- `docs/`: arquitectura, base de datos, endpoints, flujo y plan por fases.
